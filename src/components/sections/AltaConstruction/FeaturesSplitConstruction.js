...
const FeaturesSplitConstruction = ({
  className,
  topOuterDivider,
  bottomOuterDivider,
  topDivider,
...
FeaturesSplitConstruction.propTypes = propTypes;
FeaturesSplitConstruction.defaultProps = defaultProps;

export default FeaturesSplitConstruction;